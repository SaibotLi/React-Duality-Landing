      ...
      <section className="min-h-screen w-full flex flex-col md:flex-row">
        ...
        <div className="flex-1 bg-orange-800 flex justify-center items-start mb-10">
          {selectedProduct && productData[selectedProduct] ? (
            <div
              id={selectedProduct.toLowerCase()}
              className="grid grid-cols-1 md:grid-cols-3 gap-y-4 gap-x-40 max-w-screen-lg mx-auto p-4 h-5/6 place-content-start"
            >
            ...
            <p className="flex items-center h-screen text-white font-semibold">
              Elige un producto para ver imágenes.
            </p>
          )}
        </div>
      </section>
